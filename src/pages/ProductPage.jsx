...
import { FaArrowLeft, FaShoppingCart, FaCheckCircle, FaTimesCircle, FaHeart, FaChevronLeft, FaChevronRight } from 'react-icons/fa';
import { motion } from 'framer-motion';
import { useCartActions } from '../hooks/useCartActions';
import { useAdminData } from '../context/AdminDataContext';
import { migrateProductImages, getAllImages } from '../utils/imageHelpers';
            ...
            <div className="main-image">
              ...
              >
                {allImages && allImages.length > 0 && allImages[safeSelectedIndex] ? (
                  allImages[safeSelectedIndex].data && allImages[safeSelectedIndex].data.startsWith('data:image') ? (
                    <img 
            ...
            {allImages && allImages.length > 1 && (
              <div className="image-thumbnails">
                {allImages.map((image, index) => (
                  ...
                  >
                    {image && image.data && image.data.startsWith('data:image') ? (
